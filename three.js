...
const sunImg = "./dist/textures/sun.jpg";
const mercuryImg = "./dist/textures/mercury.jpg";
const venusImg = "./dist/textures/venus.jpg";
const earthImg = "./dist/textures/earth.jpg";
const marsImg = "./dist/textures/mars.jpg";
const jupiterImg = "./dist/textures/jupiter.jpg";
const saturnImg = "./dist/textures/saturn.jpg";
const saturnRing = "./dist/textures/saturn_ring.png";
const uranusImg = "./dist/textures/uranus.jpg";
const neptuneImg = "./dist/textures/neptune.jpg";
const starsImg = "./dist/textures/stars.jpg";
